function linkFormatter(value, row) {
    var classes = null;
    var path = '#/security/data-entry/retrieval-detail/general/brmunicipality-data-entry-retrieval-detail?id=' + row.id;
    var text = value;

    return tableLinkFormatter(classes, path, text);
}

system.registerCtrl('brmunicipalityDataEntryRetrievalCtrl', [
    '$scope',
    '$location',
    ...
    function (
        ...
        $scope.refresh = function () {
            var module = 'security';
            var functionality = 'brmunicipality';
        ...
        $scope.new = function () {
            $location.path('/security/data-entry/retrieval-form/general/brmunicipality-data-entry-retrieval-form');
        };
