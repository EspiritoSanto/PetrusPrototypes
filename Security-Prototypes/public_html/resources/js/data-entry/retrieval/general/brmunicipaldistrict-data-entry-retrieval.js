function linkFormatter(value, row) {
    var classes = null;
    var path = '#/security/data-entry/retrieval-detail/general/brmunicipaldistrict-data-entry-retrieval-detail?id=' + row.id;
    var text = value;

    return tableLinkFormatter(classes, path, text);
}

system.registerCtrl('brmunicipaldistrictDataEntryRetrievalCtrl', [
    '$scope',
    '$location',
    ...
    function (
        ...
        $scope.refresh = function () {
            var module = 'security';
            var functionality = 'brmunicipaldistrict';
        ...
        $scope.new = function () {
            $location.path('/security/data-entry/retrieval-form/general/brmunicipaldistrict-data-entry-retrieval-form');
        };
