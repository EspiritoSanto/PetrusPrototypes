function linkFormatter(value, row) {
    var classes = null;
    var path = '#/security/data-entry/retrieval-detail/general/brfederalunit-data-entry-retrieval-detail?id=' + row.id;
    var text = value;

    return tableLinkFormatter(classes, path, text);
}

system.registerCtrl('brfederalunitDataEntryRetrievalCtrl', [
    '$scope',
    '$location',
    ...
    function (
        ...
        $scope.refresh = function () {
            var module = 'security';
            var functionality = 'brfederalunit';
        ...
        $scope.new = function () {
            $location.path('/security/data-entry/retrieval-form/general/brfederalunit-data-entry-retrieval-form');
        };
