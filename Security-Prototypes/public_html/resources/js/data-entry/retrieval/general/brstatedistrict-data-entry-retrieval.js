function linkFormatter(value, row) {
    var classes = null;
    var path = '#/security/data-entry/retrieval-detail/general/brstatedistrict-data-entry-retrieval-detail?id=' + row.id;
    var text = value;

    return tableLinkFormatter(classes, path, text);
}

system.registerCtrl('brstatedistrictDataEntryRetrievalCtrl', [
    '$scope',
    '$location',
    ...
    function (
        ...
        $scope.refresh = function () {
            var module = 'security';
            var functionality = 'brstatedistrict';
        ...
        $scope.new = function () {
            $location.path('/security/data-entry/retrieval-form/general/brstatedistrict-data-entry-retrieval-form');
        };
